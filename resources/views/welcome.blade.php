  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <a href="index.html" class="logo d-flex align-items-center me-auto">
        ...
        <h1 class="sitename">Sustainability Olympiad</h1>  
      </a>
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="#schedule">Services</a></li>
...
@if(Auth::check())
  <b><a href="{{ url('all-series') }}" class="">Dashboard<br></a>
  </b>
<a class="cta-btn d-none d-sm-block" href="{{ url('logout') }}"
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <div class="container d-flex flex-column align-items-center text-center mt-auto">
        ...
        <br>
        <br>
        <h2 data-aos="fade-up" data-aos-delay="100" class="">SUSTAINABILITY<br><span>OLYMPIAD</span> </h2>
        <p data-aos="fade-up" data-aos-delay="100">Comprehensive and accessible platform <br>for students to enhance their knowledge and <br>understanding of sustainability concepts</p>
        <div data-aos="fade-up" data-aos-delay="200" class=""style="margin:40px;">
          <a href={{url('login')}} style="padding: 10px;padding-inline:30px;background:#0f974c;color:rgb(255, 255, 255);border-radius:50%;width:50px;">Get Started</a>
        </div>
      </div>
          ...
          <div class="col-lg-12">
            <form action="forms/contact.php" method="post" class="php-email-form" data-aos="fade-up" data-aos-delay="400">
              <div class="row gy-4">
                ...
                <div class="col-md-4">
                  <input type="text" name="name" class="form-control" placeholder="Your Contact No." required="">
                </div>
        ...
        <div class="row gy-4">
          <div class="col-lg-4 col-md-6 footer-about">
            <a href="index.html" class="logo d-flex align-items-center">
              <span class="sitename">Sustainability Olympiad</span>
            </a>
          ...
          <div class="col-lg-4 col-md-3 footer-links">
            ...
            <ul>
              ...
              <li><a href="#">Class Based</a></li>
              <li><a href="#">Various Test Series</a></li>
    ...
    <div class="copyright text-center">
      <div class="container d-flex flex-column flex-lg-row justify-content-center justify-content-lg-between align-items-center">
        ...
        <div class="d-flex flex-column align-items-center align-items-lg-start">
          <div>
            © Copyright <strong><span>Sustainability Olympiad</span></strong>. All Rights Reserved
          </div>
          <div class="credits">
           </div>
        </div>
